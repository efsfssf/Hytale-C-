...
namespace HytaleClient.AssetEditor.Backends
{
	...
	{
		// Token: 0x06005FDC RID: 24540 RVA: 0x001F0544 File Offset: 0x001EE744
		public static SchemaNode CreateHeadAccessorySchema(params string[] directory)
		{
			SchemaNode schemaNode = CosmeticSchema.CreateCosmeticSchema(directory);
		...
		// Token: 0x06005FDD RID: 24541 RVA: 0x001F05D0 File Offset: 0x001EE7D0
		...
		// Token: 0x06005FDE RID: 24542 RVA: 0x001F069C File Offset: 0x001EE89C
		public static SchemaNode CreateCosmeticSchema(params string[] directory)
		{
			...
			schemaNode.Properties.Add("Textures", schemaNode2);
