...
namespace HytaleClient.Graphics.Gizmos.Models
{
	...
	{
		// Token: 0x060055AE RID: 21934 RVA: 0x00197348 File Offset: 0x00195548
					...
					for (int k = 0; k < length3; k++)
					{
						...
						if (!flag)
						{
							for (int l = 0; l < 6; l++)
							{
								...
								bool flag2 = num3 >= 0 && num3 < length && num4 >= 0 && num4 < length2 && num5 >= 0 && num5 < length3 && blockData[num3, num4, num5];
								if (!flag2)
								{
									num += 32;
									num2 += 6;
					...
					for (int num8 = 0; num8 < length3; num8++)
					{
						...
						if (!flag3)
						{
							for (int num9 = 0; num9 < 6; num9++)
							{
								...
								bool flag4 = num10 >= 0 && num10 < length && num11 >= 0 && num11 < length2 && num12 >= 0 && num12 < length3 && blockData[num10, num11, num12];
								if (!flag4)
								{
